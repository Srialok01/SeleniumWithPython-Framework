...
class SeleniumDriver():
    ...
    def getElement(self, locator, locatorType="id"):
        ...
        try:
            ...
            self.log.info("Element Found by locator " + locator)
        except:
    ...
    def hoverOnElement(self, locator, locatorType="id"):
        try:
            element = self.getElement(locator, locatorType)
            hover = ActionChains(self.driver)
            hover.move_to_element(element).perform()
            self.log.info("successfully performed hover with locator: " + locator + " locatorType: " + locatorType)

        except:
            self.log.info("Unable to perform hover with locator: " + locator + " locatorType: " + locatorType)
            print_stack()
